...
public class GroupStartNode extends TreeNode{

	public GroupStartNode(Input x) throws CommandException {
		super(x);
...
//		    return false;
//		if(getLastChild().getType().equals(Constant.GROUPEND_TYPE))
//			return true;
		return false;
	}
